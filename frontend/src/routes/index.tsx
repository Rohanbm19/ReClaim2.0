...
function IndexPage() {
  ...
  // Redirect after login instantly at render-time
  if (!isLoaded) {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
          ...
          <div className="my-auto space-y-8 relative z-10 max-w-lg">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex gap-3.5">
                ...
                <div>
                  <h4 className="font-semibold text-white text-sm">Transparent Returns</h4>
                  <p className="text-xs text-sidebar-foreground/60 mt-0.5">Every handoff is permanently documented to prevent false claims.</p>
                </div>
              </div>
              ...
              <div className="flex gap-3.5">
                ...
                <div>
                  <h4 className="font-semibold text-white text-sm">Automated Matches</h4>
                  <p className="text-xs text-sidebar-foreground/60 mt-0.5">Match-making algorithm alerts both parties immediately upon reports.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-12 bg-slate-50 dark:bg-zinc-950">
          ...
          <div className="w-full max-w-md">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
                Sign in with your campus credentials to access the portal
              </p>
            </div>
