import { FileText, ShieldCheck, UserCheck, Phone, CheckCircle2, ArrowRight } from "lucide-react";

const steps = [
  { icon: FileText, label: "Finder reports the item" },
  { icon: ShieldCheck, label: "Admin verifies & records" },
  { icon: UserCheck, label: "Owner claims by answering questions" },
  { icon: Phone, label: "Verification & authenticity using phone number" },
